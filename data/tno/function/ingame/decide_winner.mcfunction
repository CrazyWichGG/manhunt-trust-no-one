...
## runner win
execute in minecraft:the_end if entity @a[predicate=tno:in_the_end] unless entity @e[type=ender_dragon] if score $temp tno.end_load_time matches 100.. run function tno:decide_winner/runner
## hunter win
