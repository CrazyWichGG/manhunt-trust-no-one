...
execute if score @s tno.role matches 3 if score respawn_arsonist tno.config matches 1 run return run scoreboard players set @s tno.death 0

gamemode spectator @s
tag @s add tno.dead
tag @s remove tno.arsonist.doused
