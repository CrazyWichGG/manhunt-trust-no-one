...
title @a[scores={tno.role=1,tno.role=3}] subtitle "All runners have been eliminated!"
title @a[scores={tno.role=1,tno.role=3}] title [{"text":"YOU LOST!","color":"red","bold":true}]
