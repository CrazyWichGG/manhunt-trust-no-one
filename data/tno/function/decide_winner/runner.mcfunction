...
title @a[scores={tno.role=2,tno.role=3}] subtitle "The Ender Dragon has been defeated!"
title @a[scores={tno.role=2,tno.role=3}] title [{"text":"YOU LOST!","color":"red","bold":true}]
