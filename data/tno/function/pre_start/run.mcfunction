...
execute if score $temp tno.pre_start_timer matches 55 run title @a[scores={tno.role=2}] subtitle [{"text":"Eliminate the runner to win!","color":"white"}]
...
# countdown numbers
execute if score $temp tno.pre_start_timer matches 140 run title @a subtitle ""
execute if score $temp tno.pre_start_timer matches 140 run title @a title {"text":"➌","color":"red"}
execute if score $temp tno.pre_start_timer matches 160 run title @a title {"text":"➋","color":"red"}
execute if score $temp tno.pre_start_timer matches 180 run title @a title {"text":"➊","color":"yellow"}
execute if score $temp tno.pre_start_timer matches 200 run title @a title {"text":"GO!","color":"green","bold":true}
...
execute if score $temp tno.pre_start_timer matches 200 as @a at @s run playsound minecraft:block.note_block.pling master @s ~ ~ ~ 1 2 1

# change state
execute if score $temp tno.pre_start_timer matches 200.. run scoreboard players set $temp tno.state 2

# run start script
execute if score $temp tno.pre_start_timer matches 200.. run function tno:ingame/start
